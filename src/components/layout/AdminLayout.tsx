...
import { LayoutDashboard, BookOpen, Users, Layers, LogOut, Menu, X, UserCog } from "lucide-react";
import { useState } from "react";
import { Button } from "@/components/ui/button";

// A lista de links agora inclui a página de Usuários recém-criada
const links = [
  ...
  { to: "/admin/usuarios", icon: UserCog, label: "Usuários" }, // Nova Rota Adicionada
];
  ...
  return (
    <div className="min-h-screen flex bg-background">
      ...
      <main className="flex-1 lg:ml-64">
        ...
        {/* Renderiza as páginas filhas (Dashboard, Cursos, Usuários, etc) */}
