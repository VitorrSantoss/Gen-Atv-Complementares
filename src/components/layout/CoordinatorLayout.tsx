...
import { LayoutDashboard, Users, Settings, FileCheck, LogOut, Menu, X } from "lucide-react";
    ...
    <>
      <div className="p-6 border-b border-sidebar-border">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl gradient-primary flex items-center justify-center text-primary-foreground font-bold text-sm">CO</div>
          <div>
    ...
    <div className="min-h-screen flex bg-background">
      ...
      <main className="flex-1 lg:ml-64">
        <header className="lg:hidden flex items-center gap-3 p-4 border-b border-border bg-card">
          ...
          <span className="font-semibold text-foreground">Painel Coordenador</span>
        </header>
