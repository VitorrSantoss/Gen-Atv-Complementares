...
const roles: { value: UserRole; label: string; icon: React.ReactNode; desc: string }[] = [
  ...
  { value: "superadmin", label: "Gestor", icon: <Shield className="h-6 w-6" />, desc: "Administre cursos e coordenadores" },
];
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-hero items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          <h1 className="text-3xl font-bold text-primary-foreground mb-4" style={{ fontFamily: 'Arial' }}>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8">
          <div className="flex flex-col items-center text-center lg:text-left">
            ...
            <h2 className="flex flex-col items-center text-3xl font-bold text-foreground" style={{ fontFamily: 'Arial' }}>
              Entrar no Sistema
            </h2>
            <p className="flex flex-col items-center text-muted-foreground mt-1">Selecione seu perfil e faça login</p>
          </div>
